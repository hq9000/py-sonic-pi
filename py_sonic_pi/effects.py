...
class BPF(EffectInstance):
    ...
    pre_amp_slide_shape: SlideShape = SlideShape.LINEAR
    centre: float = 100.0
    centre_slide: float = 0.0
    centre_slide_shape: SlideShape = SlideShape.LINEAR
    res: float = 0.6
    res_slide: float = 0.0
    res_slide_shape: SlideShape = SlideShape.LINEAR
    ...
    def __init__(
        ...
        self.pre_amp_slide_shape = pre_amp_slide_shape
        self.centre = centre
        self.centre_slide = centre_slide
        self.centre_slide_shape = centre_slide_shape
        self.res = res
        self.res_slide = res_slide
        self.res_slide_shape = res_slide_shape
    ...
    def get_fx_params_dict(self) -> dict[str, float]:
        return {
            ...
            "pre_amp_slide_shape": self.pre_amp_slide_shape.value,
            "centre": self.centre,
            "centre_slide": self.centre_slide,
            "centre_slide_shape": self.centre_slide_shape.value,
            "res": self.res,
            "res_slide": self.res_slide,
            "res_slide_shape": self.res_slide_shape.value,
        }
...
class RLPF(LPF):
    ...
    def __init__(
        ...
        super().__init__(id, amp, amp_slide, amp_slide_shape, mix, mix_slide, mix_slide_shape, pre_mix, pre_mix_slide, pre_mix_slide_shape, pre_amp, pre_amp_slide, pre_amp_slide_shape, cutoff, cutoff_slide, cutoff_slide_shape, controllable)
        self.res = res
        self.res_slide = res_slide
        self.res_slide_shape = res_slide_shape
    ...
    def get_fx_params_dict(self) -> dict[str, float]:
        params = super().get_fx_params_dict()
        params.update({
            "res": self.res,
            "res_slide": self.res_slide,
            "res_slide_shape": self.res_slide_shape.value,
...
class BandEQ(EffectInstance):
    ...
    db: float = 0.6
    db_slide: float = 0.0
    db_slide_shape: SlideShape = SlideShape.LINEAR
    ...
    def __init__(
        ...
        self.res_slide_shape = res_slide_shape
        self.db = db
        self.db_slide = db_slide
        self.db_slide_shape = db_slide_shape
    ...
    def get_fx_params_dict(self) -> dict[str, float]:
        return {
            ...
            "res_slide_shape": self.res_slide_shape.value,
            "db": self.db,
            "db_slide": self.db_slide,
            "db_slide_shape": self.db_slide_shape.value,
        }
...
class Normaliser(EffectInstance):
    ...
    pre_amp_slide_shape: SlideShape = SlideShape.LINEAR
    level: float = 1.0
    level_slide: float = 0.0
    level_slide_shape: SlideShape = SlideShape.LINEAR
    ...
    def __init__(
        ...
        self.level_slide_shape = level_slide_shape
    ...
    def get_fx_params_dict(self) -> dict[str, float]:
        return {
            ...
            "pre_amp_slide_shape": self.pre_amp_slide_shape.value,
            "level": self.level,
            "level_slide": self.level_slide,
            "level_slide_shape": self.level_slide_shape.value,
        }
...
class PitchShift(EffectInstance):
    ...
    pitch_slide_shape: SlideShape = SlideShape.LINEAR
    ...
    def __init__(
        ...
        self.pitch_slide_shape = pitch_slide_shape
    ...
    def get_fx_params_dict(self) -> dict[str, float]:
        return {
            ...
            "pre_amp_slide_shape": self.pre_amp_slide_shape.value,
            "pitch": self.pitch,
            "pitch_slide": self.pitch_slide,
            "pitch_slide_shape": self.pitch_slide_shape.value,
...
class Flanger(EffectInstance):
    ...
    wave: int = 0
    invert_wave: int = 0
    stereo_invert_wave: int = 0
    delay: float = 5.0
    delay_slide: float = 0.0
    delay_slide_shape: SlideShape = SlideShape.LINEAR
    max_delay: float = 20.0
    depth: float = 5.0
    depth_slide: float = 0.0
    depth_slide_shape: SlideShape = SlideShape.LINEAR
    decay: float = 2.0
    decay_slide: float = 0.0
    decay_slide_shape: SlideShape = SlideShape.LINEAR
    feedback: float = 0.0
    feedback_slide: float = 0.0
    feedback_slide_shape: SlideShape = SlideShape.LINEAR
    invert_flange: int = 0
    ...
    def __init__(
        ...
        self.wave = wave
        self.invert_wave = invert_wave
        self.stereo_invert_wave = stereo_invert_wave
        self.delay = delay
        self.delay_slide = delay_slide
        self.delay_slide_shape = delay_slide_shape
        self.max_delay = max_delay
        self.depth = depth
        self.depth_slide = depth_slide
        self.depth_slide_shape = depth_slide_shape
        self.decay = decay
        self.decay_slide = decay_slide
        self.decay_slide_shape = decay_slide_shape
        self.feedback = feedback
        self.feedback_slide = feedback_slide
        self.feedback_slide_shape = feedback_slide_shape
        self.invert_flange = invert_flange
    ...
    def get_fx_params_dict(self) -> dict[str, float]:
        return {
            ...
            "wave": self.wave,
            "invert_wave": self.invert_wave,
            "stereo_invert_wave": self.stereo_invert_wave,
            "delay": self.delay,
            "delay_slide": self.delay_slide,
            "delay_slide_shape": self.delay_slide_shape.value,
            "max_delay": self.max_delay,
            "depth": self.depth,
            "depth_slide": self.depth_slide,
            "depth_slide_shape": self.depth_slide_shape.value,
            "decay": self.decay,
            "decay_slide": self.decay_slide,
            "decay_slide_shape": self.decay_slide_shape.value,
            "feedback": self.feedback,
            "feedback_slide": self.feedback_slide,
            "feedback_slide_shape": self.feedback_slide_shape.value,
            "invert_flange": self.invert_flange,
        }
...
class PingPong(EffectInstance):
    ...
    def get_fx_params_dict(self) -> dict[str, float]:
        return {
            ...
            "pre_amp_slide": self.pre_amp_slide,
            "pre_amp_slide_shape": self.pre_amp_slide_shape.value,
            "vowel_sound": self.vowel_sound,
            "voice": self.voice,
        }
    oct1_slide_shape: SlideShape = SlideShape.LINEAR
    oct2: float = 1.0
    oct2_slide: float = 0.0
    oct2_slide_shape: SlideShape = SlideShape.LINEAR
    oct3: float = 1.0
    oct3_slide: float = 0.0
    oct3_slide_shape: SlideShape = SlideShape.LINEAR
    ...
    def __init__(
        ...
        self.pre_amp_slide_shape = pre_amp_slide_shape
        self.oct1 = oct1
        self.oct1_slide = oct1_slide
        self.oct1_slide_shape = oct1_slide_shape
        self.oct2 = oct2
        self.oct2_slide = oct2_slide
        self.oct2_slide_shape = oct2_slide_shape
        self.oct3 = oct3
        self.oct3_slide = oct3_slide
        self.oct3_slide_shape = oct3_slide_shape
    ...
    def get_fx_params_dict(self) -> dict[str, float]:
        return {
            ...
            "pre_amp_slide_shape": self.pre_amp_slide_shape.value,
            "oct1": self.oct1,
            "oct1_slide": self.oct1_slide,
            "oct1_slide_shape": self.oct1_slide_shape.value,
            "oct2": self.oct2,
            "oct2_slide": self.oct2_slide,
            "oct2_slide_shape": self.oct2_slide_shape.value,
            "oct3": self.oct3,
            "oct3_slide": self.oct3_slide,
            "oct3_slide_shape": self.oct3_slide_shape.value,
        }
